...
import { Sun, Moon, Menu, X, ArrowRight, Mail, Phone, MapPin, Download, Palette, Monitor, FileText, Smartphone, TrendingUp, Package, Diamond } from 'lucide-react';
      ...
      <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-[#0f172a] dark:text-white transition-all duration-500 ease-[cubic-bezier(0.25,0.8,0.25,1)] overflow-x-hidden">
        ...
        <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden" aria-label="Hero section">
          ...
          <div className="relative z-10 text-center px-2 sm:px-4 lg:px-6">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-bold mb-6 text-[#0f172a] dark:text-white leading-normal pb-2">
                <span className="relative">
                  <span className="text-blue-600 dark:text-blue-400 text-6xl md:text-8xl">C</span>rafting{' '}
                  <span className="text-blue-600 dark:text-blue-400 text-6xl md:text-8xl">V</span>isual{' '}
                  <span className="text-blue-600 dark:text-blue-400 text-6xl md:text-8xl">S</span>tories
                </span>
              </h1>
        ...
        {/* Work Section */}
        <section id="work" className="py-24 lg:py-32 bg-[#f8fafc] dark:bg-[#1a1a1a]" aria-label="Featured work portfolio">
        ...
        {/* Services Section */}
        <section id="services" className="py-24 lg:py-32" aria-label="Services offered">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            <motion.div
              initial="initial"
              whileInView="animate"
        ...
        {/* About Section */}
        <section id="about" className="py-24 lg:py-32 bg-[#f8fafc] dark:bg-[#1a1a1a]" aria-label="About the designer">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                  <span className="text-blue-600 dark:text-blue-400 text-5xl md:text-6xl">A</span>bout{' '}
                  <span className="text-blue-600 dark:text-blue-400 text-5xl md:text-6xl">M</span>e
                </h2>
